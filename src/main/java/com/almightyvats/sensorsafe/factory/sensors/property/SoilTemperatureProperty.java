...
public class SoilTemperatureProperty extends SensorProperty {

    public SoilTemperatureProperty(boolean isEnable, double maxValue, double minValue, String unit,
