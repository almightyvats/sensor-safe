...
public class SoilWaterContentProperty extends SensorProperty {

    public SoilWaterContentProperty(boolean isEnable, double maxValue, double minValue, String unit,
